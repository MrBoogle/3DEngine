...
vec3d operator*(mat4x4 const& m, vec3d const& v1) {
    vec3d v;
    v.x = v1.x * m.m[0][0] + v1.y * m.m[1][0] + v1.z * m.m[2][0] + m.m[3][0];
    v.y = v1.x * m.m[0][1] + v1.y * m.m[1][1] + v1.z * m.m[2][1] + m.m[3][1];
    v.z = v1.x * m.m[0][2] + v1.y * m.m[1][2] + v1.z * m.m[2][2] + m.m[3][2];
    v.w = v1.x * m.m[0][3] + v1.y * m.m[1][3] + v1.z * m.m[2][3] + m.m[3][3];
